...
import NuveiProvider, { useNuveiContext } from 'context/nuvei';
...
import NuveiWidget from '../account/sections/payment-methods/nuvei';
...
const CheckoutWrapped: React.FC<CheckoutWrappedProps> = ({ logo, ...emptyState }) => {
  ...
  return (
    <div className="min-h-screen lg:bg-neutral-200">
      ...
      <Footer />
      <NuveiWidget
        modalIsOpen={nuveiState.isModalOpened}
        closeModal={() => {}}
        handleCancelClick={() => {}}
        handleDeleteClick={() => {}}
      />
