...
export const getConfig = (context: Context, engine: string, locale: string | null): ClientConfig => {
  ...
  const clientConfig: ClientConfig = {
    ...
    nuveiEnv: getFromProjectConfig('NUVEI_ENV', context),
    nuveiMerchantId: getFromProjectConfig('NUVEI_MERCHANT_ID', context),
    nuveiMerchantSiteId: getFromProjectConfig('NUVEI_MERCHANT_SITE_ID', context),
    nuveiGoogleMerchantId: getFromProjectConfig('NUVEI_GOOGLE_MERCHANT_ID', context),
    nuveiPaymentMethodLabel: getFromProjectConfig('NUVEI_PAYMENT_METHOD_LABEL', context),
  };
